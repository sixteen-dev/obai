---
entry_type: strategy
id: openap_cb_oper_prof_lagat_q
canonical_name: Cash-based oper prof lagged assets qtrly
aliases:
- CBOperProfLagAT_q
- Cash-based oper prof lagged assets qtrly
- ProfCashLagq
one_line: Cross-sectional equity anomaly that uses Cash-based oper prof lagged assets
  qtrly to rank stocks by the signal and form the source-defined long-short spread.
category: quality
asset_classes:
- equities
...
seminal_papers:
- title: Cash-based oper prof lagged assets qtrly
  authors:
  - Ball et al.
  year: 2016
  venue: JFE
...
## Notes
Source row: acronym=CBOperProfLagAT_q; category=profitability; data=Accounting; evidence=HXZ variant. Review the generated entry before using it as a final public corpus item.
