...
entry_type: strategy
id: openap_pm_q
canonical_name: Profit Margin (Quarterly)
aliases:
- PM_q
- Profit Margin
one_line: Cross-sectional equity anomaly that uses Profit Margin to rank stocks by
...
for each rebalance date:
    compute PM_q for every eligible stock using OpenAP data rules
...
## Notes
Source row: acronym=PM_q; category=profitability; data=Accounting; evidence=HXZ variant. Review the generated entry before using it as a final public corpus item.
