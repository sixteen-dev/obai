---
entry_type: strategy
id: openap_oper_prof_lag_q
canonical_name: Operating Profits / Book Equity (Lagged Quarterly)
aliases:
- OperProfLag_q
- ProfOperLagq
...
## Notes
Source row: acronym=OperProfLag_q; category=profitability; data=Accounting; evidence=HXZ variant. Review the generated entry before using it as a final public corpus item.
