...
# Fallback constant for default parameter values.
BUILTIN_JUDGE_MODEL = "anthropic/claude-haiku-4-5-20251001"


def get_builtin_model() -> str:
    """Return the configured eval builtin model ID."""
    return get_config().eval_builtin_model
