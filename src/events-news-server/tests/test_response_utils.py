...
class TestTruncateResponse:
    ...
    def test_returns_data_unchanged_when_under_limit(self) -> None:
        ...
        data: dict[str, Any] = {
            "news": [{"title": "Apple Earnings Beat Expectations", "symbol": "AAPL"}],
        }
    ...
    def test_truncates_large_response(self) -> None:
        ...
        large_list = [{"title": f"News Article {i}", "text": "x" * 100} for i in range(500)]
        data: dict[str, Any] = {"news": large_list}
    ...
    def test_handles_nested_news_data(self) -> None:
        """Test nested news data is handled correctly."""
        data: dict[str, Any] = {
            "news": [
                {
                    "symbol": "AAPL",
