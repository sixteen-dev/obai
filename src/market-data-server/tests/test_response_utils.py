...
class TestTruncateResponse:
    ...
    def test_truncates_large_response(self) -> None:
        ...
        large_list = [
            {"symbol": f"SYM{i}", "price": 100.0 + i, "data": "x" * 100} for i in range(500)
        ]
        data: dict[str, Any] = {"candles": large_list}
    ...
    def test_handles_nested_market_data(self) -> None:
        """Test nested market data is handled correctly."""
        data: dict[str, Any] = {
            "symbol": "AAPL",
            "quote": {
                "price": 175.50,
            ...
            "candles": [
                {"date": "2024-01-15", "close": 175.50},
                {"date": "2024-01-14", "close": 173.33},
            ],
        }
