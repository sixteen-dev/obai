...
echo ""
echo "This triggers:"
echo "  - release.yml         GitHub Release with changelog"
echo "  - docker-publish.yml  Build & push Docker images to GHCR"
echo ""
echo "Verify images at:"
echo "  https://github.com/orgs/sixteen-dev/packages?repo_name=obai"
